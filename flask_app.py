...
def alphabet_checker():
    ...
    return '''<form method="POST">
                  Input: <input type="text" name="input" placeholder="Enter your input"><br>
...
def has_all_alphabets(input: str):
    if input == None:
        ...
        # put any alphabet into a set in upper case then make sure the size of the set is 26, the total number of alphabet letters
